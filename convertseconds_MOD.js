/*
 ...
 https://discord.com/channels/1247604511107715182/1273673695688134807
*/
module.exports = {
  data: {
  ...
  async run(values, message, client, bridge) {
    let time = Number(bridge.transf(values.time));
    ...
    switch (values.tipo) {
      ...
      case "[Minimum 2 digits] Show all groups":
        result =
          ...
          (a == 1 ? "" + decimal_a + ano2 : "") +
          (a == 0 ? "" + decimal_a + ano : "") +
          (mes > 1 ? "" + decimal_mes + meses : "") +
          (mes == 1 ? "" + decimal_mes + meses2 : "") +
          (mes == 0 ? "" + decimal_mes + meses : "") +
          (d > 1 ? decimal_d + dia : "") +
          (d == 1 ? "" + decimal_d + dia2 : "") +
          (d == 0 ? "" + decimal_d + dia : "") +
          (h > 1 ? decimal_h + hora : "") +
