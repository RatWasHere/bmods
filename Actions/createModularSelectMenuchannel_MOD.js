...
module.exports = {
  category: "Modularity",
  data: { name: "Create Modular Select Menu Channel", includeTextChannels: true, validity: { type: "temporary", value: "60" }, minSelectable: "1", maxSelectable: "1" },
  info: {
