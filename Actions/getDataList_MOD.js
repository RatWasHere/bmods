module.exports = {
    ...
    subtitle: (values, constants) => {
        return `Data Type: ${values.dataType} - Data Name: ${values.dataName} - Store As: ${constants.variable(values.store)}`;
    },
    compatibility: ["Any"],
    async run(values, message, client, bridge) {
        ...
        switch (resultType) {
            ...
            case 'range':
                ...
                if (rangeStart >= 0 && rangeEnd <= dataList.length && rangeStart < rangeEnd) {
