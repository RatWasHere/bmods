module.exports = {
  ...
  async run(values, message, client, bridge) {
    ...
    switch (values.get.type) {
      case "creator":
        output = event.creator ? event.creator.username : null;
        break;
      case "event_id":
        output = event.id;
        break;
      ...
      case "scheduled_end_time":
        ...
        break;
      case "image":
        output = event.image ? `https://cdn.discordapp.com/guild-events/${event.id}/${event.image}.png` : null;
        break;
      case "channel":
