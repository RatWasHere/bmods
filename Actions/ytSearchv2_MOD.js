    ...
    "-",
    {
      ...
      choices: {
        ...
        custom: {
          name: "Custom #",
          field: true,
          placeholder: "Results Start At #0",
        },
      },
    },
    {
      ...
      UItypes: {
        info: {
          ...
          name: "Info",
          preview:
            "`Store ${option.data.get} To Variable: ${option.data.store.type}('${option.data.store.value}')`",
          UI: [
            {
              element: "dropdown",
              storeAs: "get",
    ...
    for (let info of infoList) {
      ...
      switch (info.data.get) {
        case "Track":
          ...
          const { createAudioResource } = await client
            .getMods()
