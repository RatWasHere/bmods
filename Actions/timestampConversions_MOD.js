      ...
      case "custom":
        ...
        const components = {
          YYYY: new Intl.DateTimeFormat(locale, {
            year: "numeric",
            timeZone,
          }).format(date), // Full year (e.g., 2025)
          YY: new Intl.DateTimeFormat(locale, {
            year: "2-digit",
            timeZone,
          }).format(date), // Last two digits of year (e.g., 25)
          MMM: new Intl.DateTimeFormat(locale, {
            month: "short",
            timeZone,
          }).format(date), // Abbreviated month name (e.g., Jan)
          Month: new Intl.DateTimeFormat(locale, {
            month: "long",
            timeZone,
          }).format(date), // Full month name (e.g., January)
          MM: new Intl.DateTimeFormat(locale, { month: "2-digit", timeZone })
            .format(date)
            .padStart(2, "0"), // Month (01-12) - zero-padded
          DD: new Intl.DateTimeFormat(locale, { day: "2-digit", timeZone })
            .format(date)
            .padStart(2, "0"), // Day of the month (01-31) - zero-padded
          ...
          ddd: new Intl.DateTimeFormat(locale, {
            weekday: "short",
            timeZone,
          }).format(date), // Abbreviated day name (e.g., Mon)
          hh: new Intl.DateTimeFormat(locale, {
            ...
            .format(date)
            .slice(0, 2)
            .padStart(2, "0"), // Hours (00-23)
          mm: new Intl.DateTimeFormat(locale, { minute: "2-digit", timeZone })
            .format(date)
            .slice(0, 2)
            .padStart(2, "0"), // Minutes (00-59)
          ss: new Intl.DateTimeFormat(locale, { second: "2-digit", timeZone })
            .format(date)
            .slice(0, 2)
            .padStart(2, "0"), // Seconds (00-59)
        };
        output = cstmFormat.replace(
          /YYYY|YY|Month|MMM|MM|DD|Day|ddd|hh|mm|ss/g,
